...
fun defaultSkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        cardContainerColor = White.copy(alpha = 0.92f), cardContainerColorDark = Gray800.copy(alpha = 0.92f),
        cardInnerPadding = 12.dp, cardGap = 8.dp,
...
fun gothicSkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        cardContainerColor = White.copy(alpha = 0.92f), cardContainerColorDark = darkSurface.copy(alpha = 0.92f),
        cardInnerPadding = 12.dp, cardGap = 8.dp,
...
fun chineseSkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        cardContainerColor = Color(0xFFFFFDF5).copy(alpha = 0.92f), cardContainerColorDark = darkSurface.copy(alpha = 0.92f),
        cardInnerPadding = 10.dp, cardGap = 6.dp,
...
fun classicSkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        cardContainerColor = Color(0xFFFFF8F5).copy(alpha = 0.92f), cardContainerColorDark = darkSurface.copy(alpha = 0.92f),
        cardInnerPadding = 12.dp, cardGap = 8.dp,
        accentDesaturationDark = 0.1f,
...
fun navySkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        effectsSpring = spring(dampingRatio = 1.0f, stiffness = 1600f),
        cardShadowAmbientAlpha = 0.06f, cardShadowSpotAlpha = 0.10f,
        cardContainerColor = Color(0xFFF5FAFF).copy(alpha = 0.92f), cardContainerColorDark = darkSurface.copy(alpha = 0.92f),
        cardInnerPadding = 12.dp, cardGap = 8.dp,
...
fun countrySkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        effectsSpring = spring(dampingRatio = 1.0f, stiffness = 1600f),
        cardShadowAmbientAlpha = 0.06f, cardShadowSpotAlpha = 0.10f,
        cardContainerColor = warmWhite.copy(alpha = 0.92f), cardContainerColorDark = darkSurface.copy(alpha = 0.92f),
        cardInnerPadding = 14.dp, cardGap = 10.dp,
        accentDesaturationDark = 0.1f,
...
fun victorianSkinConfig(): LolitaSkinConfig {
    ...
    return LolitaSkinConfig(
        ...
        effectsSpring = spring(dampingRatio = 1.0f, stiffness = 1200f),
        cardShadowAmbientAlpha = 0.12f, cardShadowSpotAlpha = 0.18f,
        cardContainerColor = cream.copy(alpha = 0.93f), cardContainerColorDark = darkSurface.copy(alpha = 0.94f),
        cardInnerPadding = 16.dp, cardGap = 10.dp,
        accentDesaturationDark = 0.15f,
